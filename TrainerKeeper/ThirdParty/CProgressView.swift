...
@IBDesignable class CProgressView: UIView {
    ...
    // Variables
    private var π: CGFloat = CGFloat(Double.pi)
    ...
    @IBInspectable var circleColor: UIColor = UIColor(hex: 0xdddddd)
    @IBInspectable var progressColor: UIColor = UIColor.accent
    @IBInspectable var lineWidth: Float = Float(4.0)
  ...
  override func draw(_ rect: CGRect) {
    ...
    circlePath = UIBezierPath(arcCenter: centerPointArc, radius: radiusArc, startAngle: arc(arc: 0), endAngle: arc(arc: 360), clockwise: true)
